      ...
      <div class="table-responsive">
        ...
        <b-col md="12" class="mt-4">
          <b-row>
            ...
            <!--        class="text-primary text-24 line-height-1 m-0"-->
            <!--      >-->
            <!--      {{currentUser.currency}} {{formatNumber((infos.expenses.sum?infos.expenses.sum:0),2)}}-->
            <!--      </p>-->
            ...
            <!--        <span-->
            <!--          class="bold"-->
            <!--        >{{currentUser.currency}} {{formatNumber((infos.expenses_money_sent.sum?infos.expenses_money_sent.sum:0),2)}}</span>-->
            <!--        {{$t('Money Sent To Bank')}}-->
            <!--        +-->
            <!--        <span-->
            <!--          class="bold"-->
            <!--        >{{currentUser.currency}} {{formatNumber((infos.other_expenses.sum?infos.other_expenses.sum:0),2)}}</span>-->
            <!--        {{$t('Other Expenses')}}-->
            <!--        )-->
            <!--        </p>-->
            <!--      </div>-->
